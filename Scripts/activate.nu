...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Ahad\PycharmProjects\audio editor\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Ahad\PycharmProjects\audio editor\venv\Scripts\deactivate.nu'
